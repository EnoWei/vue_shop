    ...
    <el-card>
      ...
      <el-table :data="orderlist" border stripe>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" type="primary" icon="el-icon-edit" @click="showTab()"></el-button>
            <el-button
              size="mini"
              type="success"
  ...
  methods: {
    async getOrderList () {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error('获取订单管理数据失败!')
      }
    ...
    // 显示地址对话框
    showProgressBox () {
      //   const {data: res} = await this.$http.get(`/kuaidi/80490957441254480`)
      //   console.log(res.data)
      //   if (res.meta.status !== 200) {
